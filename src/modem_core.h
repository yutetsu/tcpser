...
// ATI emulation 
#define MDM_RESP_ATI_NUMERICAL_IDENTIFIER 23
#define MDM_RESP_ATI_CHECKSUM 24
#define MDM_RESP_ATI_MANUFACTURER 25
#define MDM_RESP_ATI_PRODUCT_NAME 26
#define MDM_RESP_ATI_DOB_VERSION 27
